...
export const frequentActions = {
  ElectricityBill: ['Electricity Bill', 'fas fa-newspaper fa-2xl', '/ConsumerCorner/OnlineBill'],
  BillEstimator: ['Bill Estimator', 'fas fa-calculator fa-2xl', '/ConsumerCorner/BillEstimator'],
